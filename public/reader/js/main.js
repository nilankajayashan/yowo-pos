...
(function(undefined) {
    ...
    var args = {
        ...
        resultFunction: function(res) {
            ...
            document.getElementById('product').value =  res.code;
            document.getElementById('by-name').value =  res.code;
            Notiflix.Notify.success('Scan Success - ' + res.format + ": " + res.code);
            // changeProduct(res.code);
            // scannedQR.value = res.format + ": " + res.code;
